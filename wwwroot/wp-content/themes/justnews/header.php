...
<head>
    ...
    <?php
    $favicon_base = home_url('/wp-content/uploads/2025/08');
    $favicon_ico = $favicon_base . '/favicon.ico';
    $favicon_32 = function_exists('get_site_icon_url') ? get_site_icon_url(32) : '';
    $favicon_16 = function_exists('get_site_icon_url') ? get_site_icon_url(16) : '';
    if (!$favicon_32) {
        $favicon_32 = $favicon_base . '/favicon-32x32.png';
    }
    if (!$favicon_16) {
        $favicon_16 = $favicon_base . '/favicon-16x16.png';
    }
    ?>
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?php echo esc_url($favicon_ico); ?>">
    <link rel="shortcut icon" href="<?php echo esc_url($favicon_ico); ?>">
...
<header class="header">
    <div class="container clearfix">
        <div class="navbar-header">
            ...
            $logo_url = function_exists('skyrobot_get_header_logo_url')
                ? skyrobot_get_header_logo_url($configured_logo)
                : ($configured_logo !== '' ? esc_url($configured_logo) : esc_url(get_template_directory_uri() . '/images/logo.svg'));
            ?>
